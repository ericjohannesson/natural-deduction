...
let rec string_of_fml_rec (embedded: bool) (fml : t_fml) : string =
        ...
        | BinopApp (Binop o, fml1, fml2) -> (
                match embedded with
                |true -> String.concat "" ["(";string_of_fml_rec true fml1;" ";o;" ";string_of_fml_rec true fml2;")"]
                |false -> String.concat "" [string_of_fml_rec true fml1;" ";o;" ";string_of_fml_rec true fml2]
        )
        | UnopApp (Unop o, fml) -> String.concat "" [o;string_of_fml_rec true fml]
        | QuantApp (Quant q, Var v,fml) -> String.concat "" [q;v;" ";string_of_fml_rec true fml]
