...
val items_of_file : string -> ITM_types.t_item list
(**

If [path] is the path of a file containing items conforming to the grammar specified below,

then [items_of_file path] evaluates to a list of type {!type:ITM_types.t_item}.
...
val string_of_item : ITM_types.t_item -> string

val string_of_items : ITM_types.t_item list -> string


(** {2 Expand } *)

exception Invalid_definition of ITM_types.t_item
...
val expand_items : ITM_types.t_item list -> ITM_types.t_item list
(**
...
val expand_file : string -> ITM_types.t_item list
