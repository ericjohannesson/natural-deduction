...
(** Parser for mapping objects of type {!type:PRF_sequencer.t_prf_seq} to objects of type {!type:PRF_types.t_prf}. Generated from PRF_parser.mly with {{:https://gallium.inria.fr/~fpottier/menhir/}Menhir}. *)
