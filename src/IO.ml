...
let string_of_stdin () : string = In_channel.input_all stdin
...
let print_to_stdout (s : string) : unit = print_endline s
let print_to_stderr (s : string) : unit = Printf.eprintf "%s\n" s
