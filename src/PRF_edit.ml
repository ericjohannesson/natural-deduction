...
let decompose_file (recursively : bool) (dir_path: string) (prf_path : string) : unit =
        let prf : t_prf = prf_of_file prf_path in
        if recursively then decompose_prf_rec dir_path prf else
...
let decompose_file_raw (recursively : bool) (dir_path: string) (prf_path : string) : unit =
        let prf : t_prf_raw = prf_raw_of_file prf_path in
        if recursively then decompose_prf_raw_rec dir_path prf else
...
let compose_dir (recursively : bool) (path : string) : t_prf =
...
let compose_dir_raw (recursively : bool) (path : string) : t_prf_raw =
