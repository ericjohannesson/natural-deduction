...
(**
[expand_and_validate_file options path] applies {!val:ITM_main.expand_file} to [path] and applies [validate_prf options] to each expanded proof. Prints a report to [stdout].
*)
