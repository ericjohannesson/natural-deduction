...
docs: src build_byte
	...
	cd -
	cp src/FML_lexer.mll docs/specs/
	cp src/FML_parser.mly docs/specs/
	cp src/PRF_lexer.mll docs/specs/
	cp src/PRF_parser.mly docs/specs/
	cp src/ITM_lexer.mll docs/specs/
	cp src/ITM_parser.mly docs/specs/
